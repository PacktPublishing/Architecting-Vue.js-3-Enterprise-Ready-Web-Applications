<template>
  ...
  <div v-else>
    <img src="/src/assets/kunal-img.jpg" alt="" data-testid="pin" class="w-full h-full object-cover rounded-2xl" />
    <div class="
      absolute
      top-0
      left-0
    ...
    " style="background-color: rgba(0, 0, 0, 0.6)">
      <div class="flex justify-between">
        <div class="ml-2">
          <Button type="menu" class="text-white" label="Profile">
            <template #icon>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                style="fill: rgb(255, 253, 253); transform: ; msfilter: ">
          ...
          ">
            <div class="h-[150px] bg-white w-full px-4 rounded-2xl pt-5">
              ...
              <div class="
                ...
                mt-5
              ">
                <input type="text" placeholder="Search" class="w-full bg-transparent outline-none pl-3" />
              </div>
            </div>
        ...
        <Button appearance="secondary" @click="createNewPin" data-testid="create_pin" label="Save"></Button>
      </div>
      <div class="flex justify-between">
        <Button appearance="secondary" label="yputube...">
          <template #icon>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
              style="fill: rgba(0, 0, 0, 1); transform: ; msfilter: ">
              <path
